export interface WorkOrder { id: string; pump_id: string; station_id: string; title: string; description: string | null; priority: string; due_at: string | null; status: string; source: string; created_by_user_id: string | null; assigned_to_user_id: string | null; source_alert_id: string | null; source_prediction_id: string | null; completion_note: string | null; root_cause: string | null; corrective_action: string | null; downtime_minutes: number | null; follow_up_required: boolean; follow_up_due_at: string | null; closed_at: string | null; outcome: string | null; post_maintenance_condition: string | null; completed_by_user_id: string | null; verified_at: string | null; verified_by_user_id: string | null; verification_result: string | null; verification_note: string | null; }
