...
export default function WorkOrdersPage() {
  ...
  async function setStatus(id: string, status: string) { try { await api(`/work-orders/${id}`, { method: "PATCH", body: JSON.stringify({ status }) }); showToast("Work order completed"); await load(); } catch (e) { showToast((e as Error).message); } }
